...
public class WebPagePostTripDVIR {

WebDriver driver;
	
	WebDriverWait wait;

	public static Logger log = Logger.getLogger(WebPagePostTripDVIR.class);
	
	public WebPagePostTripDVIR(WebDriver driverinstance)
	{
