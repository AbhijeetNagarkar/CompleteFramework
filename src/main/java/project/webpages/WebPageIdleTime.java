...
public class WebPageIdleTime {
	
WebDriver driver;
	
	WebDriverWait wait;

	public static Logger log = Logger.getLogger(WebPageIdleTime.class);
	
	public WebPageIdleTime(WebDriver driverinstance)
	{
	...
	public boolean SearchandVerifyRecords() throws InterruptedException {
		...
		List<WebElement> ele = driver.findElements(By.xpath("//tbody[@class=\"rc-table-tbody\"]//tr//td[@class=\"rc-table-cell\"][0]"));
		if(ele.size()==0)
		{
	...
	public Boolean filterandverification() throws InterruptedException
	{
		try
		{
			...
			List<WebElement> ele = driver.findElements(By.xpath("//tbody[@class=\"rc-table-tbody\"]//tr//td[@class=\"rc-table-cell\"][0]//a//div"));
