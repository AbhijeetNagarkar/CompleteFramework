...
public class CarrierInfo extends ConfigurationSetup{

public static Logger log = Logger.getLogger(CarrierInfo.class);
	...
	@Test(priority=0, groups = "Carrier Info")
	public void GETCarrierInfo(ITestContext context) throws IOException 
	{
		String targetAPI = APIurl+"client-services/api/v1/fms/carrier-info/";
		...
		try
		{
			MatcherAssert.assertThat(res.body().asPrettyString(), JsonSchemaValidator.matchesJsonSchema(CarrierinfoSchema));
		}
		catch(Exception e)
		{
