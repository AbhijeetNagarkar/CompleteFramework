...
public class Trailerslist extends ConfigurationSetup{

	public static Logger log = Logger.getLogger(Trailerslist.class);
	...
	@Test(priority=0, groups = "Trailers List")
	public void GetTrailersList(ITestContext context) throws IOException 
	{
		String targetAPI = APIurl+"client-services/api/v1/fms/trailers-list/";
		...
		try
		{
			MatcherAssert.assertThat(res.body().asPrettyString(), JsonSchemaValidator.matchesJsonSchema(TailerslistSchema));
		}
		catch(Exception e)
		{
