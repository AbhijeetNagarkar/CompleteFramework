...
public class Elogs extends ConfigurationSetup{
	
	public static Logger log = Logger.getLogger(Elogs.class);
	...
	@Test(priority=0, groups = "Elogs")
	public void GETElogs(ITestContext context) throws IOException 
	{
		String targetAPI = APIurl+"client-services/api/v1/fms/elogs/";
		...
		AddQueryParameter("Elogs start");

		AddQueryParameter("Elogs limit");
		...
		try
		{
			MatcherAssert.assertThat(res.body().asPrettyString(), JsonSchemaValidator.matchesJsonSchema(ELogsSchema));
		}
		catch(Exception e)
		{
