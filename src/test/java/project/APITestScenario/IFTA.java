...
public class IFTA extends ConfigurationSetup{

	public static Logger log = Logger.getLogger(IFTA.class);
	...
	public void GETIFTA(ITestContext context) throws IOException 
	{
		
	String targetAPI = APIurl+"client-services/api/v1/fms/ifta/";
		...
		try
		{
			MatcherAssert.assertThat(res.body().asPrettyString(), JsonSchemaValidator.matchesJsonSchema(IFTASchema));
