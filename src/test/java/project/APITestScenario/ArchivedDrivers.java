...
public class ArchivedDrivers extends ConfigurationSetup{

	
	public static Logger log = Logger.getLogger(ArchivedDrivers.class);
	...
	@Test(priority=1, groups = "Archived Drivers")
	public void GETArchivedDrivers(ITestContext context) throws IOException 
	{
		String targetAPI = APIurl+"client-services/api/v1/fms/archived-drivers/";
		...
		try
		{
			MatcherAssert.assertThat(res.body().asPrettyString(), JsonSchemaValidator.matchesJsonSchema(ArchivedDriversSchema));
		}
		catch(Exception e)
		{
