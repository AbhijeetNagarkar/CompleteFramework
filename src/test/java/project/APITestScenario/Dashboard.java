...
public class Dashboard extends ConfigurationSetup{
	
public static Logger log = Logger.getLogger(Dashboard.class);
	...
	@Test(priority=0, groups = "Dashboard")
	public void GETDashboard(ITestContext context) throws IOException 
	{
		String targetAPI = APIurl+"client-services/api/v1/fms/dashboard/";
		...
		try
		{
			MatcherAssert.assertThat(res.body().asPrettyString(), JsonSchemaValidator.matchesJsonSchema(DashboardSchema));
		}
		catch(Exception e)
		{
