...
public class TruckList extends ConfigurationSetup {
	
	public static Logger log = Logger.getLogger(TruckList.class);
	...
	@Test(priority=0, groups = "Truck List")
	public void GetTruckList(ITestContext context) throws IOException 
	{
		String targetAPI = APIurl+"client-services/api/v1/fms/truck-list/";
		...
		try
		{
			MatcherAssert.assertThat(res.body().asPrettyString(), JsonSchemaValidator.matchesJsonSchema(TruckListSchema));
		}
		catch(Exception e)
		{
