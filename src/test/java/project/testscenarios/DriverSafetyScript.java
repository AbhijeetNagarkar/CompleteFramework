...
public class DriverSafetyScript {
	...
	@Test(priority = 50,groups = {"Driver Safety Reports"})
	...
	@Test(priority = 51,groups = {"Driver Safety Reports"},dependsOnMethods = "NavigatingDriverSafetyPage" )
	...
	@Test(priority = 52,groups = {"Driver Safety Reports"},dependsOnMethods = "NavigatingDriverSafetyPage" )
